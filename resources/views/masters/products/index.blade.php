                ...
                <tbody>
                    @forelse($products as $product)
                        <tr>
                            ...
                            <td>
                                @can('product.edit')
                                    <form action="{{ route('masters.products.toggle-status', $product) }}" method="POST" class="js-confirm"
                                          data-confirm="{{ ($product->status === 'active' ? 'Deactivate' : 'Activate') . ' product "' . $product->name . '"?' }}">
                                        @csrf @method('PATCH')
